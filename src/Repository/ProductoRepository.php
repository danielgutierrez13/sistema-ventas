...
class ProductoRepository extends BaseRepository
{
    ...
    public function findAllActivo(): array
    {
        $queryBuilder = $this->createQueryBuilder('producto')
            ...
            ->addSelect('producto.precio as precio')
            ->addSelect('producto.stock as stock')
            ->addSelect('producto.categoria as categoria')
            ->addSelect('producto.marca as marca')
            ->addSelect('producto.unidadMedida as unidadMedida')
            ->addSelect('producto.precioVenta as precioVenta')
            ->addSelect('producto.codigo as codigo')
